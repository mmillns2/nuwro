...
$(BIN)/nuwro:   $(addprefix src/,\
        pauli.o cohevent2.o cohdynamics2.o qelevent1.o hypevent.o hyperon_interaction.o hyperon_cascade.o kaonevent.o kaon_diff_xsec.o CT.o 23Scatter.o lepevent.o nu_e_el_sigma.o\
...
$(BIN)/ganalysis: $(addprefix src/, \
	event1.o event1Dict.o generatormt.o particle.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o mecdynamics.o mecevent.o hypevent.o hyperon_interaction.o hyperon_cascade.o kaonevent.o kaon_diff_xsec.o CT.o 23Scatter.o lepevent.o\
...
$(BIN)/reweight_to: $(addprefix src/, \
	nuwro.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o hypevent.o hyperon_interaction.o hyperon_cascade.o kaonevent.o kaon_diff_xsec.o CT.o 23Scatter.o lepevent.o nu_e_el_sigma.o\
...
$(BIN)/reweight_along: $(addprefix src/, \
	event1.o event1Dict.o generatormt.o particle.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o mecdynamics.o mecevent.o hypevent.o hyperon_interaction.o hyperon_cascade.o kaonevent.o kaon_diff_xsec.o CT.o 23Scatter.o lepevent.o nu_e_el_sigma.o\
